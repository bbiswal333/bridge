...
var AsteroidsGame = ArcadeJS.extend({
    init: function(canvas, customOpts) {
        ...
        // --- Cache sounds ----------------------------------------------------
        this.gunSound = new AudioJS(["lib/asteroidsGame/fire.mp3", "lib/asteroidsGame/fire.oga", "lib/asteroidsGame/fire.wav"]);
        this.explosionSound = new AudioJS(["lib/asteroidsGame/damage.mp3", "lib/asteroidsGame/damage.oga"]);

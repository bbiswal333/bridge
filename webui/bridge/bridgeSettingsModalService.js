angular.module('bridge.service').service('bridge.service.bridgeSettingsModalService', [ "$modal", "bridgeDataService", bridgeSettingsModalService ]);

function bridgeSettingsModalService ($modal, bridgeDataService) {
	return {    

    ...
    beforeEach(function () {
        ...
        inject(["$window", "$q", "$httpBackend", "bridgeDataService", "bridgeInstance", "bridge.service.appCreator", "bridgeInBrowserNotification", function (_$window, q, httpBackend, _bridgeDataService, bridgeInstance, appCreator, _bridgeInBrowserNotification) {
            ...
            $httpBackend.whenGET('https://ifp.wdf.sap.corp/sap/bc/bridge/GET_VIEW?view=TeamView1&instance=' + bridgeInstance.getCurrentInstance() + '&origin=' + encodeURIComponent($window.location.origin))
                .respond('{"name": "Team View 1","type":"TEAM","view":"TeamView1","apps":[{"metadata":{"module_name": "app.atc","content":"app.atc","id":4,"guid": "app.atc-4","show":true,"boxTitle":"ATC Results","boxIconClass":" icon-wrench"},"appConfig":{"configItems":[]}}]}');
            $httpBackend.whenGET('https://ifp.wdf.sap.corp/sap/bc/bridge/GET_VIEW?view=TeamView2&instance=' + bridgeInstance.getCurrentInstance() + '&origin=' + encodeURIComponent($window.location.origin))
                .respond('{"name": "Team View 2","type":"TEAM","view":"TeamView2","apps":[{"metadata":{"module_name": "app.atc","content":"app.atc","id":4,"guid": "app.atc-4","show":true,"boxTitle":"ATC Results","boxIconClass":" icon-wrench"},"appConfig":{"configItems":[]}}]}');

describe("bridge map service", function() {
	...
	beforeEach(function() {
		...
		inject(["bridge.service.maps.routing", "$httpBackend", "$interval", function(_mapService, $httpBackend, $interval) {
			...
			httpBackend.whenGET(new RegExp('https:\\/\\/route.nlp.nokia.com\\/routing\\/7.2\\/calculateroute.json\\?waypoint0=link!!%2B1599025847254060527&waypoint1=geo!49.41349,8.70807&alternatives=2&routeattributes=none,routeId&language=en-US&mode=fastest;car;traffic:disabled.*')).respond(ROUTES_RESPONSE);
			...
			httpBackend.whenGET(new RegExp('https:\\/\\/route.nlp.nokia.com\\/routing\\/7.2\\/calculateroute.json\\?waypoint0=geo!49.2931652,8.6422384&waypoint1=link!!%2B1599025847254060527&waypoint2=link!!%2B1599025847254060871&waypoint3=link!!%2B1599025842908758185&waypoint4=link!!%2B1599377686612869120&waypoint5=link!!%2B1599377695219581129&waypoint6=link!!-1599377695219581103&waypoint7=link!!%2B1599377695219581111&alternatives=0&routeattributes=none,routeId&language=en-US&mode=fastest;car;traffic:disabled.*')).respond(REBUILD_ROUTE_ID);

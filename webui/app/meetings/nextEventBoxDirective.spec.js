...
describe("nextEventBoxDirective ewsHelperUtils test", function () {
	...
	it("should be tested by a working test :-)", function () {
		...
		var url = window.client.origin + "localhost:8000/api/getCalDataSSO?dateFrom=" + encodeForUrl("2014-01-30T10:15:05Z") + "&dateTo=" + encodeForUrl("2014-02-02T10:15:05Z") + "&format=json";
		var expectation = new RegExp(".*\?dateFrom=" + encodeForUrl("2014-01-30T10:15:05Z") + "&dateTo=" + encodeForUrl("2014-02-02T10:15:05Z") + "&format=json$");
	...
	it("should oncemore build a correct url", function () {
		...
		var expectation = new RegExp(".*\?dateFrom=" + encodeForUrl("2014-02-28T00:00:00Z") + "&dateTo=" + encodeForUrl("2014-03-01T00:00:00Z") + "&format=json$");

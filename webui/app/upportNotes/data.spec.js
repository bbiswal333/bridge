describe("Upport Notes data", function() {
	var upportNotesDataService, configService, $httpBackend, detailsResponse, $timeout, AKHResponsibleFactory;
	...
	beforeEach(function () {
        ...
        inject(["$httpBackend", "app.upportNotes.dataService", "app.upportNotes.configService", "$timeout", "bridge.AKHResponsibleFactory", function (_$httpBackend, _upportNotesDataService, _configService, _$timeout, _AKHResponsibleFactory) {
    ...
    describe("retrieval", function() {
        describe("summary", function() {
            ...
            it("should call the backend service with single config item", function(done) {
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks/$count?$filter=CM_PRIORITY eq '1' and ((CM_CREATION_DATE gt datetime'2016-04-15T07:08:18.804Z') and (PRG_ID eq 'ID1' or PRG_ID eq 'ID2' or PRG_ID eq 'ID3') and (PPMS_CV_SW_COMP_T eq 'COMP1' or PPMS_CV_SW_COMP_T eq 'COMP2') and (CM_ACRF_COMP eq 'COMP3' or startswith(CM_ACRF_COMP, 'COMP4') or CM_ACRF_COMP eq 'AC' or CM_ACRF_COMP eq 'AC-CO'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n21\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks/$count?$filter=CM_PRIORITY eq '2' and ((CM_CREATION_DATE gt datetime'2016-04-15T07:08:18.804Z') and (PRG_ID eq 'ID1' or PRG_ID eq 'ID2' or PRG_ID eq 'ID3') and (PPMS_CV_SW_COMP_T eq 'COMP1' or PPMS_CV_SW_COMP_T eq 'COMP2') and (CM_ACRF_COMP eq 'COMP3' or startswith(CM_ACRF_COMP, 'COMP4') or CM_ACRF_COMP eq 'AC' or CM_ACRF_COMP eq 'AC-CO'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n42\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
                var configItem = configService.getNewItem();
                ...
                configItem.addAKHResponsible(AKHResponsibleFactory.createInstance("PROP", "D012345"));
            ...
            it("should call the backend service with multiple config items", function(done) {
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks/$count?$filter=CM_PRIORITY eq '1' and ((PRG_ID eq 'ID1' and PRG_ID ne 'ID2') and (PPMS_CV_SW_COMP_T eq 'COMP1') and (not startswith(CM_ACRF_COMP, 'COMP1')) or (PRG_ID eq 'ID3') and (startswith(CM_ACRF_COMP, 'COMP1')))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n21\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks/$count?$filter=CM_PRIORITY eq '2' and ((PRG_ID eq 'ID1' and PRG_ID ne 'ID2') and (PPMS_CV_SW_COMP_T eq 'COMP1') and (not startswith(CM_ACRF_COMP, 'COMP1')) or (PRG_ID eq 'ID3') and (startswith(CM_ACRF_COMP, 'COMP1')))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n42\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
                var configItem = configService.getNewItem();
                configItem.addProgram("ID1", "Program");
        ...
        describe("details", function() {
            it("should call the backend service with single config item", function(done) {
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks?$format=json&$filter=CM_PRIORITY eq '1' and ((PRG_ID eq 'ID1' or PRG_ID eq 'ID2' or PRG_ID eq 'ID3') and (PPMS_CV_SW_COMP_T eq 'COMP1' or PPMS_CV_SW_COMP_T eq 'COMP2') and (CM_PROCESSOR eq 'D0123456' or CM_PROCESSOR eq 'D0123457'))") + postRequestEnd).respond(200, detailsResponse);
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks?$format=json&$filter=CM_PRIORITY eq '2' and ((PRG_ID eq 'ID1' or PRG_ID eq 'ID2' or PRG_ID eq 'ID3') and (PPMS_CV_SW_COMP_T eq 'COMP1' or PPMS_CV_SW_COMP_T eq 'COMP2') and (CM_PROCESSOR eq 'D0123456' or CM_PROCESSOR eq 'D0123457'))") + postRequestEnd).respond(200, detailsResponse);
                var configItem = configService.getNewItem();
                configItem.addProgram("ID1", "Program");
                configItem.addProgram("ID2", "Program");
                configItem.addProgram("ID3", "Program");
            ...
            it("should separate the processor name into first and last name", function(done) {
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks?$format=json&$filter=CM_PRIORITY eq '1' and ((PRG_ID eq 'ID1'))") + postRequestEnd).respond(200, detailsResponse);
                $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/cwbr/reporting/bridge/Notes.xsodata/$batch", postRequestBeginning + encodeURI("UpportChecks?$format=json&$filter=CM_PRIORITY eq '2' and ((PRG_ID eq 'ID1'))") + postRequestEnd).respond(200, detailsResponse);
                var configItem = configService.getNewItem();
                configItem.addProgram("ID1", "Program");
                configService.addItem(configItem);
                ...
                upportNotesDataService.loadDetails().then(function() {
                    expect(upportNotesDataService.details.length).toEqual(6);
                    expect(upportNotesDataService.details[0].CM_PROCESSOR_NAME).toEqual("Christoph Vehns");
                    expect(upportNotesDataService.details[0].CM_PROCESSOR_FIRST_NAME).toEqual("Christoph");
                    expect(upportNotesDataService.details[0].CM_PROCESSOR_LAST_NAME).toEqual("Vehns");
                    expect(upportNotesDataService.details[0].CM_DEV_DLM_NAME).toEqual("Michael Mayer");
                    expect(upportNotesDataService.details[0].CM_DEV_DLM_FIRST_NAME).toEqual("Michael");
                    expect(upportNotesDataService.details[0].CM_DEV_DLM_LAST_NAME).toEqual("Mayer");
                    done();
                }, function() {
                    expect("this").toBe("not happening");
                    done();

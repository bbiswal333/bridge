ddescribe("Incidents data", function() {
    ...
    describe("by Program", function() {
        ...
        it("should filter on program with system exclude", function(done) {
            ...
            $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/intm/reporting/bridge/InternalIncidents.xsodata/$batch", postRequestBeginning + encodeURI("IncidentByProgram?$format=json&$filter=II_PRIORITY_ID eq '2' and ((TP_PROGRAM eq 'GUID1') or (TP_PROGRAM eq 'GUID2' and II_SYSTEM_ID ne 'EMW' and II_SYSTEM_ID ne 'EOS') or (TP_PROGRAM eq 'GUID3'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n2\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
            ...
            $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/intm/reporting/bridge/InternalIncidents.xsodata/$batch", postRequestBeginning + encodeURI("IncidentByProgram?$format=json&$filter=II_PRIORITY_ID eq '4' and ((TP_PROGRAM eq 'GUID1') or (TP_PROGRAM eq 'GUID2' and II_SYSTEM_ID ne 'EMW' and II_SYSTEM_ID ne 'EOS') or (TP_PROGRAM eq 'GUID3'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n4\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
            configService.addProgram({TP_PROGRAM: "GUID1"});
        ...
        it("should filter on program and component", function(done) {
            ...
            $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/intm/reporting/bridge/InternalIncidents.xsodata/$batch", postRequestBeginning + encodeURI("IncidentByProgram?$format=json&$filter=II_PRIORITY_ID eq '2' and ((TP_PROGRAM eq 'GUID1')) and ((II_CATEGORY eq 'COMP1' or startswith(II_CATEGORY, 'COMP2')) and II_CATEGORY ne 'COMP3' and not startswith(II_CATEGORY, 'COMP4'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n2\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
            ...
            $httpBackend.whenPOST("https://mithdb.wdf.sap.corp/oprr/intm/reporting/bridge/InternalIncidents.xsodata/$batch", postRequestBeginning + encodeURI("IncidentByProgram?$format=json&$filter=II_PRIORITY_ID eq '4' and ((TP_PROGRAM eq 'GUID1')) and ((II_CATEGORY eq 'COMP1' or startswith(II_CATEGORY, 'COMP2')) and II_CATEGORY ne 'COMP3' and not startswith(II_CATEGORY, 'COMP4'))") + postRequestEnd).respond(200, "--7138BA946C8877F70E52AF41D5E066240\r\nContent-Type: application/http\r\nContent-Length: 80\r\ncontent-transfer-encoding: binary\r\n\r\nHTTP/1.1 200 OK\r\nContent-Type: text/plain;charset=utf-8\r\nContent-Length: 2\r\n\r\n4\r\n--7138BA946C8877F70E52AF41D5E066240--\r\n");
            configService.addProgram({TP_PROGRAM: "GUID1"});

angular.module('app.clock').service("app.clock.configService", function() {
    ...
    this.getDefaultValue = function(theOption) {
        ...
        switch (theOption) {
            case 'boxSize': return this.defaults.boxSize;
            case 'clockFacePlace': return this.defaults.formats.clockFacePlace;
            case 'multipleClocks': return this.defaults.formats.multipleClocks;
            case 'clockFaceHours': return this.defaults.formats.clockFaceHours;
            case 'clockMeridiem': return this.defaults.formats.clockMeridiem;
            case 'clockSeparator': return this.defaults.formats.clockSeparator;
            case 'dateSeparator': return this.defaults.formats.dateSeparator;
            case 'dateType': return this.defaults.formats.dateType;
            case 'clockSeconds': return this.defaults.formats.clockSeconds;
            case 'clockZeroToHour': return this.defaults.formats.clockZeroToHour;
            case 'dateCentury': return this.defaults.formats.dateCentury;
            case 'dateText': return this.defaults.formats.dateText;
            case 'multipleClockOrder': return this.defaults.formats.multipleClockOrder;
            case 'showActiveDST': return this.defaults.formats.showActiveDST;
            case 'datetextOrder': return this.defaults.formats.datetextOrder;
        }

    ...
    function ($http, $q, $window, $rootScope, $location, $timeout, configService, notifier, converter) {
        var Data = function(appId) {
            ...
            function parseBackendTicket(backendTicket, category) {
                ...
                angular.forEach(that.prios, function (prio) {
                    if (backendTicket.PRIORITY_KEY === prio.number.toString()) {
                        ...
                        // incidents with status Solution Provided/Confirmed/Confirmed Automatically are not considered at all
                        else if (backendTicket.STATUS_KEY === "E0005" || backendTicket.STATUS_KEY === "E0009" || backendTicket.STATUS_KEY === "E0010") {
            ...
            this.loadTicketData = function () {
                ...
                var requestUrl = 'https://support.wdf.sap.corp/sap/bc/devdb/customer_incid?sap-client=001&max_hits=1000&sap-language=EN';

describe("Ticket Data Service for InternalMessages", function () {
    ...
    var mockDataWithDuplicates = '<asx:abap xmlns:asx="http://www.sap.com/abapxml" version="1.0"><asx:values><INTCOMP_SHORT><ESKGRND/><PRIO1>0</PRIO1><PRIO2>0</PRIO2><PRIO3>0</PRIO3><PRIO4>0</PRIO4></INTCOMP_SHORT><INTCOMP_LONG></INTCOMP_LONG><INTPERS_SHORT><ESKGRND/><PRIO1>0</PRIO1><PRIO2>0</PRIO2><PRIO3>0</PRIO3><PRIO4>0</PRIO4></INTPERS_SHORT><INTPERS_LONG></INTPERS_LONG><INTCREATED_SHORT><ESKGRND/><PRIO1>0</PRIO1><PRIO2>1</PRIO2><PRIO3>0</PRIO3><PRIO4>0</PRIO4></INTCREATED_SHORT><INTCREATED_LONG><DEVDB_INTMESSAGE_OUT><CSINSTA>0120031469</CSINSTA><MNUMM>0004595382</MNUMM><MYEAR>2013</MYEAR><PRIO>2</PRIO><PRIOSTXT>High</PRIOSTXT><STATUSSTXT>In Process</STATUSSTXT><STATUS/><KTEXT>Wrong status of test plan generation from ABAP Unit Runner</KTEXT><THEMKEXT>BC-SRV-AGL</THEMKEXT><ESKGRND/><ESKTEXT/><ERFDATUM>2013-11-14</ERFDATUM><ERFZEIT>14:37:54</ERFZEIT><FIRMA/><ADRNR>0100257019</ADRNR><SUSID>D050420</SUSID><SAPNA>SPENGLERM</SAPNA><VORNA>Michael</VORNA><NACHN>Spengler</NACHN><TEL01>43844</TEL01><AEDATUM>2013-11-26</AEDATUM><AEZEIT>10:37:53</AEZEIT><SOURCE/><PROJECTID/><CORSYSTEM>F5V</CORSYSTEM><CORRELEASE/><MPTDATUM>2013-11-25</MPTDATUM><MPTZEIT>03:41:53</MPTZEIT><AENAME>D021522</AENAME><WORKPRIO>600</WORKPRIO><INFO/><NW_RELEASE>740</NW_RELEASE></DEVDB_INTMESSAGE_OUT></INTCREATED_LONG><INTAUTHACTION_SHORT><ESKGRND/><PRIO1>0</PRIO1><PRIO2>0</PRIO2><PRIO3>0</PRIO3><PRIO4>0</PRIO4></INTAUTHACTION_SHORT><INTAUTHACTION_LONG></INTAUTHACTION_LONG><INTCOMPCOLLEAGUES_SHORT><ESKGRND/><PRIO1>0</PRIO1><PRIO2>1</PRIO2><PRIO3>0</PRIO3><PRIO4>0</PRIO4></INTCOMPCOLLEAGUES_SHORT><INTCOMPCOLLEAGUES_LONG><DEVDB_INTMESSAGE_OUT><CSINSTA>0120031469</CSINSTA><MNUMM>0004595382</MNUMM><MYEAR>2013</MYEAR><PRIO>2</PRIO><PRIOSTXT>High</PRIOSTXT><STATUSSTXT>In Process</STATUSSTXT><STATUS/><KTEXT>Wrong status of test plan generation from ABAP Unit Runner</KTEXT><THEMKEXT>BC-SRV-AGL</THEMKEXT><ESKGRND/><ESKTEXT/><ERFDATUM>2013-11-14</ERFDATUM><ERFZEIT>14:37:54</ERFZEIT><FIRMA/><ADRNR>0100257019</ADRNR><SUSID>D050420</SUSID><SAPNA>SPENGLERM</SAPNA><VORNA>Michael</VORNA><NACHN>Spengler</NACHN><TEL01>43844</TEL01><AEDATUM>2013-11-26</AEDATUM><AEZEIT>10:37:53</AEZEIT><SOURCE/><PROJECTID/><CORSYSTEM>F5V</CORSYSTEM><CORRELEASE/><MPTDATUM>2013-11-25</MPTDATUM><MPTZEIT>03:41:53</MPTZEIT><AENAME>D021522</AENAME><WORKPRIO>600</WORKPRIO><INFO/><NW_RELEASE>740</NW_RELEASE></DEVDB_INTMESSAGE_OUT></INTCOMPCOLLEAGUES_LONG><INTSUBSCRIPTIONS_LONG></INTSUBSCRIPTIONS_LONG><ERRORS/></asx:values></asx:abap>';
    var deferred;
    var configService;
    ...
    beforeEach(function () {
        ...
        inject(function($injector){
            configService = $injector.get('app.im.configservice');
        });
    ...
    it("should reset the priorities in the data structure", function () {
        ...
        expect(imTicketData.prios[3].tickets.length).toBe(0);
    });
    ...
    describe("in handling of duplicted messages", function () {
        ...
        beforeEach(function () {
            $httpBackend.whenGET('https://css.wdf.sap.corp:443/sap/bc/devdb/MYINTERNALMESS?sap-language=en&origin=' + location.origin).respond(mockDataWithDuplicates);
        });
        afterEach(function(){
            $httpBackend.flush();
        });
        ...
        it("should update correct count for selection", function(){
            imTicketData.loadTicketData().then(function(){
                ...
                configService.data.selection.created_me = true;
                imTicketData.updatePrioSelectionCounts();
                expect(imTicketData.prios[0].selected).toBe(0);
                expect(imTicketData.prios[1].selected).toBe(1);
            }); 

angular.module("app.cats.allocationBar.utils", []).service("app.cats.allocationBar.utils.colorUtils", function () {
    ...
    this.colors = [
            ...
            "#3F96D3",
            "#6BB9F0",
            "#16354A url(/../../img/stripes3.png)",
            "#005997 url(/../../img/stripes3.png)",
            "#0077CA url(/../../img/stripes3.png)",
            "#3F96D3 url(/../../img/stripes3.png)",
            "#6BB9F0 url(/../../img/stripes3.png)",
            "#16354A url(/../../img/stripes4.png)",
            "#005997 url(/../../img/stripes4.png)",
            "#0077CA url(/../../img/stripes4.png)",
            "#3F96D3 url(/../../img/stripes4.png)",
            "#6BB9F0 url(/../../img/stripes4.png)",

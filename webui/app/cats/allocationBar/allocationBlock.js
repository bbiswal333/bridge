    ...
    var BarBlock = function(svg_o, stackedBarInput_o, desc_s, width_i, height_i, x, y, color_s) {
        ...
        this.initBlock = function() {
            ...
            this.textField.main = s.text(function(add) {
                self.textField.desc = add.tspan(self.desc);
                self.textField.val = add.tspan(getCurrentValue()).newLine();
            }).font({
                anchor: "middle"
            }).style({
        ...
        function getCurrentValue() {
            return (Math.floor(self.getWidth() / self.p.getWidth() * 10000) / 100) + " %";
        }
        ...
        function updateTextField() {
            self.textField.val.clear().text(getCurrentValue());
